...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain why complex setup, a workaround, or a non-obvious interaction is required; do not narrate the test steps.
...
- [ ] Comments explain intent and remain accurate; none merely restate the test code
